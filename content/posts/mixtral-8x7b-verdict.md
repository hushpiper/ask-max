...
- _All Mixtral-style MoE models will tend to loop or parrot._ This seems to be a limitation of the architecture, as it holds true for both finetunes and "4 to 8 existing models in a trench coat" type merges. IME the official 8x7b Instruct model does it the least, as of 12/20/23.
